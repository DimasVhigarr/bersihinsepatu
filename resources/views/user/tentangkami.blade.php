...
<nav class="bg-white shadow-md">
  ...
  <!-- About Us Content -->
  <main class="flex-grow bg-indigo-50 py-16 px-6 sm:px-12 max-w-7xl mx-auto">
   ...
   <div class="max-w-4xl mx-auto space-y-8 text-gray-700 text-lg leading-relaxed">
    ...
    <img alt="Experienced shoe cleaning trainer demonstrating techniques to a group of students in a bright classroom" class="rounded-lg shadow-lg mx-auto" height="400" src="{{ asset('images/logo.jpg') }}" width="600"/>
    <h2 class="text-2xl font-semibold text-indigo-700 mt-12 text-center">
     Misi Kami
    </h2>
    <p>
    ...
    <h2 class="text-2xl font-semibold text-indigo-700 mt-8 text-center">
     Visi Kami
    </h2>
    <p>
