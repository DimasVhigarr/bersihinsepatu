...
<head>
    ...
    <title>Profil Saya - Bersihin.Sepatu</title>
    ...
    <main class="flex-grow max-w-3xl mx-auto px-6 sm:px-12 py-16">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 space-y-10">
            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-8">
                <img src="https://storage.googleapis.com/a1aa/image/a1ae9a6c-44a1-42ca-15da-b9755d8907fe.jpg" class="rounded-full w-36 h-36 object-cover mx-auto sm:mx-0" />
                <div class="mt-6 sm:mt-0 flex-1">
                    ...
                    <p class="text-gray-600 mb-6">Bergabung sejak {{ $user->created_at->format('F Y') }}</p>
