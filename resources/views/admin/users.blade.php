...
<div class="flex flex-1">
  ...
  <form method="GET" action="{{ route('admin.users') }}" class="flex items-end flex-wrap gap-4">
     <div>
    <label for="name" class="block text-sm font-medium text-gray-700">Nama</label>
    <input type="text" name="name" id="name" value="{{ request('name') }}" placeholder="Cari nama..." class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" />
  </div>
    <div>
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('admin.users') }}" class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400">
            Reset
        </a>
    </div>
</form>
